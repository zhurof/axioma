          ...
          <div class="page__content">
            <div class="staff">
              <div class="box staff__box">
                ...
                <div class="employee-card">
                  <a href="doctor.php" class="employee-card__link"></a>
                  <img src="img/doctors/5.jpg" alt="" class="employee-card__img">
                  <h4 class="employee-card__title">Лисицына <b>Асия</b></h4>
                  <div class="employee-card__position">Врач стоматолог-ортодонт</div>
                  <a href="#" class="btn btn_small btn_gray employee-card__btn">Записаться</a>
                </div>
                <div class="employee-card">
                  <a href="doctor.php" class="employee-card__link"></a>
                  <img src="img/doctors/6.jpg" alt="" class="employee-card__img">
                  <h4 class="employee-card__title">Ковалев <b>Елисей</b></h4>
                  <div class="employee-card__position">Врач стоматолог-терапевт</div>
                  <a href="#" class="btn btn_small btn_gray employee-card__btn">Записаться</a>
                </div>
                <div class="employee-card">
                  <a href="doctor.php" class="employee-card__link"></a>
                  <img src="img/doctors/7.jpg" alt="" class="employee-card__img">
                  <h4 class="employee-card__title">Алешкова <b>Татьяна</b></h4>
                  <div class="employee-card__position">Врач стоматолог-терапевт, хирург</div>
                  <a href="#" class="btn btn_small btn_gray employee-card__btn">Записаться</a>
                </div>
                <div class="employee-card">
                  <a href="doctor.php" class="employee-card__link"></a>
                  <img src="img/doctors/8.jpg" alt="" class="employee-card__img">
                  <h4 class="employee-card__title">Окунев <b>Павел</b></h4>
                  <div class="employee-card__position">Стоматолог-ортопед</div>
                  <a href="#" class="btn btn_small btn_gray employee-card__btn">Записаться</a>
                </div>
              </div>
            </div>
